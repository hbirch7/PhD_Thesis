...
\end{equation}
where $\alpha=e^2/4\pi\epsilon_0\hbar c\approx1/137$ is the fine structure constant, $z$ is the charge of the muon (in units of electric charge), $\gamma=1/\sqrt{1-\frac{v^2}{c^2}}$ is the Lorentz factor, $v$ is the velocity of the muon with mass $m_\mu$ and energy $E$, $I\simeq16\:\cdot\:Z^{0.9}$ eV is the mean ionisation potential of the atom \cite{GROOM2001183}. As the energy of the muon increases, the electric field extends to large distances, increasing the number of interactions with distant electrons. This effect is corrected for in \autoref{eqn:Muons/BetheBloch} by the density correction term $\delta(\beta\gamma)$.
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/Muons/MuonIntensityVSVertDepth.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/Muons/Flux_Depth_Plot.pdf}
...
\begin{table}[ht!]
    ...
    \begin{tabular}{|c|c|c|}
        \hline
        \textbf{Laboratory} & \textbf{Depth [km]} & \textbf{Muon flux [$\text{cm}^{-2}\text{s}^{-1}$]}\\
        \hline
...
\begin{figure*}[ht!]
   ...
   % \hfill
    ...
    \end{subfigure}
    \caption{\autoref{fig:Muons/Prim_E}, \autoref{fig:Muons/cosZ}, and \autoref{fig:Muons/azi} show the angular distributions and the kinetic energy spectrum of muons at the Davis campus, as generated by the MUSUN model. \autoref{fig:Muons/SurfaceProfile} shows the surface altitude profile of the area above the Davis Cavern surrounding SURF. Figure reprinted from Ref.~\cite{LZ_SIMS}.} 
    \label{fig:Muons/Prime_info}
\end{figure*}

Muons generated by MUSUN were transported through the rock, laboratory hall and detector geometry BACCARAT and their energy depositions in all "sensitive volumes" were recorded. In this simulation, $48.2\times10^6$ muons were propagated which corresponds to a live time of 9147 days (0.0610 muons per second), providing about 30 times higher statistics than for data collected during WS2022 and WS2024 science runs.
...
\begin{figure}[ht!]
    \centering \includegraphics[width=\textwidth]{figures/Muons/LZap_waveform.pdf}
    \caption{LZ event-viewer output of typical muon event. PMT saturation is evident towards the end of the muon ‘tail’ in the TPC. A train of pulses is produced in the TPC as the muon ionises xenon nuclei along its track.}
...
\end{subfigure}
\caption{Inter-detector timing plots, these distributions were used in defining the timing selection following the skim of the WS2022 and WS2024 datasets looking at events with a pulse greater than 2000~phd in the Outer Detector. The figures depict (\autoref{fig:Muons/OD-Skin}) the time difference between the largest pulse in the Outer Detector and the largest pulse in the Skin; (\autoref{fig:Muons/OD-TPC}) the time difference between the largest pulse in the Outer Detector and the start of the muon tail in the TPC; and (\autoref{fig:Muons/Skin-TPC}) the time difference between the largest pulse in the Skin and the start of the muon tail in the TPC.}
...
\end{figure}
The steady ratio between data and simulation above the 10~MeV was the primary reason for adopting to use the LG dataset. In addition to the stability in ratio, a low threshold such as $<~1$~MeV, would not be useful because these events are not muon-only events as seen through visual inspection of events around this threshold in the LZ event viewer. Event below 1~MeV were considered to be the end of a muon cascade in both data and simulations. To demonstrate this, a particle ID selection study was performed. \autoref{fig:Muons/Muon_PID} shows that most events $>~10$~MeV are muon-only events, not events containing muons and additional muon secondaries, as it separates the events with a muon passing through the TPC from those that do not. A higher energy threshold such as $<~50$~MeV would also not be useful due the effect of PMT saturation seen in data as shown in \autoref{fig:Muons/TPCHGLGComp_energy}.
\begin{figure}[ht!]
    \centering
...
The event selection considers a triple coincidence between the OD, Skin and TPC. However, all that is required in the Skin detector is a pulse which is classified as a `max pulse' in LZap and the pulse must have an amplitude greater than 1~phd/ns. The selection eliminates coincidence noise in the skin.
...
\end{figure}
After converting both TPC and OD pulse area to energy a direct comparison was made between combined TPC and OD energy spaces in simulations and data. These distributions can are shown in \autoref{fig:Muons/ODTPC_comp} before and after applying the TPC energy threshold selection.
...
\begin{table}[ht!]
    ...
    \hline
    TPC $>$ 1.44 keV &  16.550 ± 0.043 &  12.709 ± 0.359 & 0.768 ± 0.022  &  12.780 ± 0.360 & 0.772 ± 0.022  &    -0.004 ± 0.031 \\ 
    \hline
    TPC $>$ 1 MeV &  15.055 ± 0.041 &  12.224 ± 0.352 & 0.812 ± 0.023  &  12.305 ± 0.353 & 0.817 ± 0.024  &    -0.005 ± 0.033 \\
    \hline
    TPC $>$ 2 MeV &  14.477 ± 0.040 &  11.940 ± 0.348 & 0.825 ± 0.024  &  12.143 ± 0.351 & 0.839 ± 0.024  &    -0.014 ± 0.034 \\
    \hline
    TPC $>$ 5 MeV &  13.760 ± 0.039 &  11.485 ± 0.341 & 0.835 ± 0.025  &  11.546 ± 0.342 & 0.839 ± 0.025  &    -0.004 ± 0.035 \\
    \hline
    TPC $>$ 10 MeV &  13.275 ± 0.038 &  11.191 ± 0.337 & 0.843 ± 0.025  &  11.141 ± 0.336 & 0.839 ± 0.025  &     0.004 ± 0.036 \\
    \hline
    TPC $>$ 20 MeV &  12.840 ± 0.037 &  10.837 ± 0.331 & 0.844 ± 0.026  &  10.625 ± 0.328 & 0.827 ± 0.026  &     0.017 ± 0.036 \\
    \hline
    TPC $>$ 30 MeV &  12.597 ± 0.037 &  10.655 ± 0.328 & 0.846 ± 0.026  &  10.331 ± 0.323 & 0.820 ± 0.026  &     0.026 ± 0.037 \\
    \hline
    TPC $>$ 40 MeV &  12.413 ± 0.037 &  10.524 ± 0.326 & 0.848 ± 0.026  &  10.088 ± 0.320 & 0.813 ± 0.026  &     0.035 ± 0.037 \\
    \hline
...
\begin{table}[ht!]
    ...
    \textbf{threshold} & \textbf{rate [day$^{-1}$]} & \textbf{rate [day$^{-1}$]} & \textbf{LG ratio} & \textbf{rate [day$^{-1}$]} & \textbf{HG ratio} & \textbf{HG ratio} \\
    \hline
    TPC $>$ 1.44 keV & 16.550 ± 0.043 & 12.769 ± 0.218 & 0.772 ± 0.013  & 12.821 ± 0.219 & 0.775 ± 0.013  &-0.003 ± 0.019 \\ 
    \hline
    TPC $>$ 1 MeV & 15.055 ± 0.041 & 12.063 ± 0.212 & 0.801 ± 0.014  & 12.137 ± 0.213 & 0.806 ± 0.014  &-0.005 ± 0.020 \\ 
    \hline
    TPC $>$ 2 MeV & 14.477 ± 0.040 & 11.730 ± 0.209 & 0.810 ± 0.015  & 11.838 ± 0.210 & 0.818 ± 0.015  &-0.007 ± 0.021 \\ 
    \hline
    TPC $>$ 5 MeV & 13.760 ± 0.039 & 11.270 ± 0.205 & 0.819 ± 0.015  & 11.259 ± 0.205 & 0.818 ± 0.015  & 0.001 ± 0.021 \\ 
    \hline
    TPC $>$ 10 MeV & 13.275 ± 0.038 & 10.975 ± 0.203 & 0.827 ± 0.015  & 10.941 ± 0.202 & 0.824 ± 0.015  & 0.003 ± 0.022 \\ 
    \hline
    TPC $>$ 20 MeV & 12.840 ± 0.037 & 10.624 ± 0.199 & 0.827 ± 0.016  & 10.542 ± 0.198 & 0.821 ± 0.016  & 0.006 ± 0.022 \\ 
    \hline
    TPC $>$ 30 MeV & 12.597 ± 0.037 & 10.430 ± 0.197 & 0.828 ± 0.016  & 10.258 ± 0.196 & 0.814 ± 0.016  & 0.014 ± 0.022 \\ 
    \hline
    TPC $>$ 40 MeV & 12.413 ± 0.037 & 10.246 ± 0.196 & 0.825 ± 0.016  & 10.052 ± 0.194 & 0.810 ± 0.016  & 0.016 ± 0.022 \\ 
    \hline
...
\begin{table}[ht!]
    ...
    \textbf{threshold} & \textbf{rate [day$^{-1}$]} & \textbf{rate [day$^{-1}$]} & \textbf{LG ratio}\\
    \hline
    TPC $>$ 1.44 keV & 16.550 ± 0.043 & 12.753 ± 0.187 & 0.771 ± 0.011 \\ 
    \hline
    TPC $>$ 1 MeV & 15.055 ± 0.041 & 12.106 ± 0.182 & 0.804 ± 0.012\\ 
    \hline
    TPC $>$ 2 MeV & 14.477 ± 0.040 & 11.787 ± 0.179 & 0.814 ± 0.013 \\ 
    \hline
    TPC $>$ 5 MeV & 13.760 ± 0.039 & 11.328 ± 0.176 & 0.823 ± 0.013  \\ 
    \hline
    TPC $>$ 10 MeV & 13.275 ± 0.038 & 11.033 ± 0.174 & 0.831 ± 0.013 \\ 
    \hline
    TPC $>$ 20 MeV & 12.840 ± 0.037 & 10.681 ± 0.171 & 0.832 ± 0.014  \\ 
    \hline
    TPC $>$ 30 MeV & 12.597 ± 0.037 & 10.490 ± 0.169 & 0.833 ± 0.014  \\ 
    \hline
    TPC $>$ 40 MeV & 12.413 ± 0.037 & 10.321 ± 0.168 & 0.832 ± 0.014  \\ 
    \hline
...
Reconstruction of the muon flux from the measured muon rate was done by scaling the simulated muon flux by the same ratio as that for the measured-to-simulated rate:
\begin{equation}
...
\begin{itemize}
    ...
    \item $-100~\text{ns}<$ Time difference between OD and Skin Pulse $< 100~\text{ns}$
...
The muon veto had a impact of $3.24\%$ and $1.90\%$ on the WS2022 and WS2024 detector live time respectively. The impact that the muon veto had on detector live time over WS2022 and WS2024 science runs is shown in \autoref{fig:WS2022_MuonVetoLivetimeImpact} and \autoref{fig:WS2024_MuonVetoLivetimeImpact}, included is the impact that the OD and Skin veto algorithms (discussed in \autoref{chap:VetoEfficiency}) had on detector live time.
\begin{figure}[ht!]
    \centering
