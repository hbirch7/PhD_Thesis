...
\begin{figure}
     ...
     \begin{subfigure}{0.47\textwidth}
         \centering
         \includegraphics[width=0.79\textwidth]{figures/LZ/CAD_TPC.jpg}
         \caption{}
         \label{fig:CAD_TPC}
     \end{subfigure}
     ...
     \textcolor{red}{should I ref figures or use left/right.}}
\end{figure}
