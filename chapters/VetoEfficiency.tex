\chapter{Veto Efficiency Studies for WS2024}
...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.48\textwidth}
         \centering
         \includegraphics[width=\textwidth]{figures/cuts/skin_prompt.png}
     ...
     \begin{subfigure}[b]{0.48\textwidth}
         \centering
         \includegraphics[width=\textwidth]{figures/cuts/od_prompt.png}
...
\begin{sidewaysfigure}
     \centering
     \includegraphics[width=\textwidth]{figures/cuts/HeatmapODPACoinScanWindow600.pdf}
...
\begin{sidewaysfigure}
     \centering
     \includegraphics[width=\textwidth]{figures/cuts/HeatmapSkinPACoinScanWindow500.pdf}
...
\begin{sidewaysfigure}
 \centering
 \includegraphics[width=\textwidth]{figures/efficiency/HeatMapOD_PA_ScanWindow_deadtime.png}
...
\end{sidewaysfigure}
\begin{sidewaysfigure}{\textwidth}
 \centering
 \includegraphics[width=\textwidth]{figures/efficiency/HeatMap_ODPA_SkinPA_eff.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{figures/cuts/cut_optimisation.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{figures/efficiency/sr3_cuts.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{figures/deadtime/SR3DeadTimeAll_expoFunc.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{figures/deadtime/prem_od_stability.png}
...
\begin{figure}
            \centering
            \includegraphics[width=0.5\textwidth]{figures/efficiency/CircularCSDCut.pdf}
...
\begin{figure}
        \centering
        \includegraphics[width=0.5\linewidth]{figures/efficiency/AmLi_700mm_Total_CSDSelection.pdf}
...
\begin{figure}
            \centering
            \includegraphics[width=0.8\textwidth]{figures/efficiency/SR3NRBands.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/efficiency/SR3AmLi_700_Corrections_100k_P0.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/efficiency/SR3AmLi_700_Corrections_100k_P0-1.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/efficiency/AccidentalCorrectionImpact.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/efficiency/DDAccCorrectionImpact_P0.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/efficiency/DDAccCorrectionImpact_1-P0.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/efficiency/DDAccCorrectionParameters.pdf}
...
\begin{figure}
\centering
\includegraphics[width=.3\textwidth]{figures/efficiency/InEff_AmLi_Total_Avg_Ratio.pdf}\hfill
\includegraphics[width=.3\textwidth]{figures/efficiency/InEff_AmLi_Delayed_Avg_Ratio.pdf}\hfill
\includegraphics[width=.3\textwidth]{figures/efficiency/InEff_AmLi_ODDelayed_Avg_Ratio.pdf}
...
\begin{figure}
\centering
\includegraphics[width=.3\textwidth]{figures/efficiency/InEff_DDDirect_Total_Ratio.pdf}\hfill
\includegraphics[width=.3\textwidth]{figures/efficiency/InEff_DDDirect_Delayed_Ratio.pdf}\hfill
\includegraphics[width=.3\textwidth]{figures/efficiency/InEff_DDDirect_ODDelayed_Ratio.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{figures/efficiency/det_nr_efficiency.png}
