...
The measured muon rates from simulations, HG and LG data for WS2022 and WS2024 are shown in \autoref{tab:Muons/Rates2022} and \autoref{tab:Muons/Rates2024} respectively. The ratios as a function of TPC threshold is shown in \autoref{fig:Muons/TPCHGLGComp} for both HG and LG datasets.
\begin{landscape}
\begin{table}[ht!]
    \centering
